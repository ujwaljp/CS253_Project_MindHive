    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bookmarkQuestions', models.ManyToManyField(blank=True, related_name='user_bq', to='questions.Question')),
                ('favouriteTags', models.ManyToManyField(blank=True, to='tags.Tag')),
                ('followingQuestions', models.ManyToManyField(blank=True, related_name='user_fq', to='questions.Question')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reportedUser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reported', to=settings.AUTH_USER_MODEL)),
