...
class TestReportquestionchecks():
  ...
  def test_reportquestionchecks(self):
    ...
    self.driver.execute_script("if(arguments[0].contentEditable === 'true') {arguments[0].innerText = '<p>question for report<br></p>'}", element)
    ...
    self.driver.find_element(By.ID, "id_report_text").click()
    self.driver.find_element(By.ID, "id_report_text").send_keys("offensive")
    self.driver.find_element(By.CSS_SELECTOR, "form > input:nth-child(4)").click()
    self.driver.find_element(By.CSS_SELECTOR, ".nav-item:nth-child(3) #dropdownMenuButton").click()
    self.driver.find_element(By.LINK_TEXT, "Logout").click()
  

testClass = TestReportquestionchecks()

testClass.setup_method("")
testClass.test_reportquestionchecks()
