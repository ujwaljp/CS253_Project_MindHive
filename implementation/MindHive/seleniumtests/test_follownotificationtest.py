...
class TestFollownotificationtest():
  ...
  def test_follownotificationtest(self):
    ...
    self.driver.find_element(By.ID, "id_title").send_keys("follow test")
    element = self.driver.find_element(By.LINK_TEXT, "Styles")
    ...
    self.driver.execute_script("if(arguments[0].contentEditable === 'true') {arguments[0].innerText = '<p>testing the follow and notification part<br></p>'}", element)
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".follow > .fa-regular").click()
    self.driver.find_element(By.ID, "followingButton").click()
    self.driver.find_element(By.CSS_SELECTOR, ".nav-item:nth-child(3) #dropdownMenuButton").click()
    self.driver.find_element(By.LINK_TEXT, "Logout").click()
    self.driver.find_element(By.ID, "signin").click()
    self.driver.find_element(By.ID, "id_password").send_keys("wsxc1234")
    ...
    self.driver.find_element(By.NAME, "comment_text").send_keys("added to check notification")
    ...
    self.driver.find_element(By.XPATH, "//div[@id=\'navbarResponsive\']/ul/li/div/div/a[2]").click()
    self.driver.find_element(By.CSS_SELECTOR, ".nav-item:nth-child(3) #dropdownMenuButton").click()
    self.driver.find_element(By.LINK_TEXT, "Logout").click()

testClass = TestFollownotificationtest()

testClass.setup_method("")
testClass.test_follownotificationtest()
